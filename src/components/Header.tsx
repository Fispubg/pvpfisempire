...
const navLinks = [
  { label: "Home", href: "https://fisempirecf.pages.dev/", isExternal: true },
  { label: "Leaderboard", href: "https://pvpfisempire.pages.dev/", isExternal: true },
  { label: "Socials", href: "https://fisempirecf.pages.dev/", isExternal: true },
